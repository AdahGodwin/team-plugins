        ...
        items: [
            {
                icon:    Bell,
                label:   'Notifications',
                sub:     'Alerts, reminders, summaries',
                iconBg:  'bg-amber-100',
                ...
                <main className="flex-1 p-4 sm:p-6 max-w-3xl mx-auto w-full space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-6 shadow-sm">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-blue-500 to-teal-500 flex items-center justify-center text-white font-extrabold text-xl shadow-sm shrink-0">
                                {MOCK_PATIENT.name[0]}
                            </div>
                            ...
                            <button className="text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-100 px-3 py-2 rounded-xl hover:bg-blue-100 transition-colors shrink-0">
                                Edit
                            </button>
                        </div>
                        ...
                        <div className="border-t border-slate-100 mt-4 pt-4 grid grid-cols-3 gap-3 text-center">
                            <div>
                                ...
                                <p className="text-slate-400 text-[10px] sm:text-xs">Day streak</p>
                            </div>
                            <div className="border-x border-slate-100">
                                <p className="text-slate-900 font-extrabold text-sm sm:text-base">
                                    {MOCK_PATIENT.bpAvg}
                                </p>
                                <p className="text-slate-400 text-[10px] sm:text-xs">Avg BP</p>
                            </div>
                            <div>
                                <p className="text-slate-900 font-extrabold text-sm sm:text-base capitalize">
                                    {MOCK_PATIENT.riskLevel}
                                </p>
                                <p className="text-slate-400 text-[10px] sm:text-xs">Risk level</p>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <p className="text-rose-600 font-semibold text-sm sm:text-base">Log out</p>
                            <p className="text-slate-400 text-xs sm:text-sm mt-0.5">Sign out of your account</p>
                        </div>
                    ...
                    <p className="text-center text-slate-300 text-xs pb-2">
                        Aegis v1.0.0 · Built for stroke prevention
                    </p>
