        ...
        <section id="how-it-works" className="bg-white py-24">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-6 relative">
                    ...
                    <div className="hidden md:block absolute top-10 left-[22%] right-[22%] h-px bg-slate-200" />

                    {steps.map((step) => (
                        <div
                            key={step.number}
                            className="relative bg-white rounded-2xl p-8 border border-slate-200 hover:border-emerald-200 hover:bg-emerald-50/20 hover:shadow-lg transition-all group shadow-sm ring-1 ring-slate-50"
                        >
                            <div className="absolute -top-4 left-8 bg-white border border-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-xs font-bold text-slate-400 group-hover:border-emerald-300 group-hover:text-emerald-500 transition-colors shadow-sm">
                                {step.number}
                            </div>

                            <div className="w-12 h-12 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 mb-5 shadow-sm group-hover:scale-105 transition-transform">
                                {step.icon}
                            </div>
