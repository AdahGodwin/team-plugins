...
const notifications: Notification[] = [
    ...
    },
    {
        ...
        iconColor: 'text-teal-500', bgColor: 'bg-teal-50', borderColor: 'border-teal-100',
        ...
        <section className="bg-slate-50 py-24">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="flex justify-center mb-6">
                    <span className="inline-flex items-center gap-2 border border-teal-200 bg-teal-50 text-teal-700 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full">
                ...
                <div className="bg-linear-to-r from-blue-500 to-teal-500 rounded-3xl p-8 text-white text-center shadow-xl">
                    <h3 className="text-2xl font-extrabold mb-2 tracking-tight">Complete Continuum of Care</h3>
                    <p className="text-blue-50/90 text-sm max-w-xl mx-auto leading-relaxed mb-6">
                    ...
                    <Link
                        to="/auth/register"
                        className="group inline-flex items-center gap-2 bg-white text-blue-600 font-bold px-8 py-3.5 rounded-2xl hover:bg-blue-50 transition-all shadow-md active:scale-[0.98]"
                    >
                        Start Your Journey
